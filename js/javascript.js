window.addEventListener('load',
    function () {
        ...
        let token = "EAACBHKPzZBGMBAJIUqJ7wfiX8uZBgd9mb33Cuv7nx8RZAG0I6SN71t0hdUZCTmHEbUyWoAuwme8Xr9K4xDqdIne1dWH1hqndQpIZA7419N1NNbZAKIMXH9LXFjAMV1YPMuiOhhb3ClBQghvYUlSOFsCyqx4mG5M6746mZBnbleJffqwOYsk6hoEcZBZAR8ZB7RfvBcMwyZArNEv3gZDZD";
                ...
                $.get(url, function (responseText) {
                    ...
                    for(let x = 0; x < responseText["albums"]["data"].length; x++) {
                        if(x === responseText["albums"]["data"].length - 1) {
                            setTimeout(function() { albumId(responseText["albums"]["data"][x]["id"], false, true, (x + (maxAlb * manyBefore))); }, 500 * x);
                        } else {
                            setTimeout(function() { albumId(responseText["albums"]["data"][x]["id"], false, false, (x + (maxAlb * manyBefore))); }, 500 * x );
                        }
                    }
